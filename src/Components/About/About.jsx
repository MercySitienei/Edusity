  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation , hands-on learning, and personalizeed mentorship, our programs prepare aspiring educators to make a meaningful impact in classrooms, school, and communities.</p>
